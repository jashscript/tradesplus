...
public class ForbidTrade {

    public static Inventory build(){
        Inventory inventory = Bukkit.createInventory(null, 27, TradesPlus.translateText("&dForbid Trade |"));
    ...
    private static ItemStack divider(){
        ...
        ItemMeta meta = stack.getItemMeta();
        meta.setDisplayName(" ");
        ArrayList<String> lore = new LoreBuilder().addLore("&l&a< Item to be forbid")
                .build();
        meta.setLore(lore);
        stack.setItemMeta(meta);
        return stack;
